...
contract FishcakeTestHelperTest is FishcakeDeployerTest {
    ...
    function test_FishCakeCoin_PoolAllocate() public {
        ...
        uint256 MINING_POOL_balance = tempFishCakeCoin.balanceOf(address(proxyFishcakeEventManager));
        console.log("FishCakeCoin test_PoolAllocate MINING_POOL_balance:", MINING_POOL_balance);
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 3 / 10 == MINING_POOL_balance, "MINING_POOL_balance is 300000000000000"
        );
        ...
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 2 / 10 == DIRECT_SALE_POOL_balance,
        ...
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 1 / 10 == INVESTOR_SALE_POOL_balance,
        ...
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 2 / 10 == NFTSALES_REWARDS_POOL_balance,
            "NFTSALES_REWARDS_POOL_balance is 200000000000000"
        );

        uint256 ECOSYSTEM_POOL_balance = tempFishCakeCoin.balanceOf(ECOSYSTEM_POOL);
        console.log("FishCakeCoin test_PoolAllocate ECOSYSTEM_POOL_balance:", ECOSYSTEM_POOL_balance);
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 1 / 10 == ECOSYSTEM_POOL_balance,
        ...
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 1 / 10 == FOUNDATION_POOL_balance,
        ...
        assertTrue(
            tempFishCakeCoin.MaxTotalSupply() * 0 / 10 == REDEMPTION_POOL_balance, "REDEMPTION_POOL_balance is 0"
        );
        ...
        uint256 MINING_POOL_fcc_balance = tempFishCakeCoin.FccBalance(address(proxyFishcakeEventManager));
        assertTrue(
            (tempFishCakeCoin.MaxTotalSupply() * 3 / 10) == MINING_POOL_fcc_balance,
