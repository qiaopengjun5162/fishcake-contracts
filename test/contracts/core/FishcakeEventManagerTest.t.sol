...
contract FishcakeEventManagerTest is NftManagerTest {
    ...
    function test_activity() public {
        ...
        console.log(
            "FishcakeEventManagerTest test_activity block.timestamp + maxDeadLine:",
            block.timestamp + tempFishcakeEven.maxDeadLine()
        );
        ...
        console.log(
            "FishcakeEventManagerTest test_activity activityAdd before_deployerAddress_balance:",
            before_deployerAddress_balance
        );

        vm.startBroadcast(deployerAddress);
        uint256 fcc_amount = temp_totalDropAmts;
        erc20.approve(address(tempFishcakeEven), fcc_amount);
        (bool success, uint256 activityId) = tempFishcakeEven.activityAdd(
            temp_businessName,
            temp_activityContent,
            temp_latitudeLongitude,
            temp_activityDeadLine,
            temp_totalDropAmts,
            temp_dropType,
            temp_dropNumber,
            temp_minDropAmt,
            temp_maxDropAmt,
            temp_tokenContractAddr
        );
        vm.stopBroadcast();
        ...
        console.log(
            "FishcakeEventManagerTest test_activity activityAdd after_deployerAddress_balance:",
            after_deployerAddress_balance
        );
        assertTrue(
            after_deployerAddress_balance == (before_deployerAddress_balance - fcc_amount),
            "after_deployerAddress_balance == (before_deployerAddress_balance - fcc_amount)"
        );
        ...
        console.log(
            "FishcakeEventManagerTest test_activity drop_1 before_drop_account_1_balance:",
            before_drop_account_1_balance
        );
        console.log(
            "FishcakeEventManagerTest test_activity drop_1 before_tempFishcakeEven_balance_1:",
            before_tempFishcakeEven_balance_1
        );
        ...
        console.log(
            "FishcakeEventManagerTest test_activity drop_1 after_drop_account_1_balance:", after_drop_account_1_balance
        );
        console.log(
            "FishcakeEventManagerTest test_activity drop_1 after_tempFishcakeEven_balance_1:",
            after_tempFishcakeEven_balance_1
        );

        assertTrue(
            after_drop_account_1_balance == (before_drop_account_1_balance + drop_drop_amount),
            "after_drop_account_1_balance == (before_drop_account_1_balance + drop_drop_amount)"
        );
        assertTrue(
            after_tempFishcakeEven_balance_1 == (before_tempFishcakeEven_balance_1 - drop_drop_amount),
            "after_tempFishcakeEven_balance_1 == (before_tempFishcakeEven_balance_1 - drop_drop_amount)"
        );
        ...
        console.log(
            "FishcakeEventManagerTest test_activity before_activityFinish_deployerAddress_balance:",
            before_activityFinish_deployerAddress_balance
        );
